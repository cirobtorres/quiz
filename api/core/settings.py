...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.getenv('DB_NAME') or "CHANGEME",
        'USER': os.getenv('DB_USER') or "CHANGEME",
        'PASSWORD': os.getenv('DB_PASS') or "CHANGEME",
        'HOST': os.getenv('DB_HOST') or "CHANGEME",
        'PORT': os.getenv('DB_PORT') or "CHANGEME"
    }
}
